...
// // Sync localStorage → cookie so middleware can read it
// function syncCookie() {
...
//   // On mount: if already logged in, sync cookie and redirect
//   useEffect(() => {
//     if (!loading && token) {
//       syncCookie();
...
//         // auth-context already sets the cookie — just navigate
//         window.location.href = "/chat";
//       } else {
